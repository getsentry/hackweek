/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=wrangler.production.json` (hash: b4706c739f212cec96f09221af2ad9d7)
...
interface __BaseEnv_Env {
	...
	APP_ORIGIN: "https://hackweek.sentry-internal.workers.dev";
	GOOGLE_REDIRECT_URI: "https://hackweek.sentry-internal.workers.dev/api/auth/callback";
	GOOGLE_CLIENT_ID: "694837489680-25m2umkr51lofdads5uvocgtcdqcs6c4.apps.googleusercontent.com";
	ALLOWED_EMAIL_DOMAIN: "sentry.io";
	VIDEO_PROCESSOR: DurableObjectNamespace<import("./src/worker/index").VideoProcessorContainer>;
	VIDEO_PROCESSING_WORKFLOW: Workflow<Parameters<import("./src/worker/index").VideoProcessingWorkflow['run']>[0]['payload']>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/worker/index");
		durableNamespaces: "VideoProcessorContainer";
	}
